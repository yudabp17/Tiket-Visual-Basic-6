...
Begin VB.Form Form5 
   BackColor       =   &H00FFFFFF&
   Caption         =   "PEMESANAN TIKET CITILINK"
   ClientHeight    =   8430
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   5760
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox CboAsal 
         Height          =   315
         ItemData        =   "TIKET CITILINK.frx":0000
         Left            =   435
         List            =   "TIKET CITILINK.frx":0002
         TabIndex        =   20
         Text            =   "Kota Asal"
         Top             =   2880
         Width           =   1695
